...
.goods_detail
    ...
    >div:nth-child(2)
        ...
        >div
            ...
            background url('../../assets/img/cxj_detail/b-b-fs8_abb5d4.png') no-repeat center/3.51rem 0.79rem
            >p
                font-size 0.12rem
                color #fff
    ...
    >div:nth-child(3)
        ...
        >div
            height 0.37rem
            background-image linear-gradient(to right, #F8DDC9, #F2C6A6)
    ...
    >div:nth-child(4)
        ...
        img 
            ...
            height 100%
    >div:nth-child(5)
        margin 0.1rem 0.15rem 0 0.12rem
        height 1.2rem
        display flex
