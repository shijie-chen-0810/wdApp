<template>
  <main>
    <div class="container">
      <div class="row">
        <div class="col-md-6 align-self-center yhy">
        ...
        <div class="col-md-6 align-self-center">
          <h1 class="err1">404</h1>
          <h2 class="err2">UH OH! 页面丢失</h2>
          <p class="err3">您所寻找的页面不存在。你可以点击下面的按钮，返回主页。</p>
          <a href="/home" class="btn-a"><button class="btn green">返回首页</button></a>
        </div>
      </div>
    </div>
  </main>
...
<script>
import gsap from 'assets/err/gsap.min.js'
import script from 'assets/err/script.js'
export default {
  data () {
    return {
      gsap,
...
<style lang="stylus" scoped>
  @import  '~assets/err/bootstrap.min.css'
  @import  '~assets/err/style.css'
  .container
    margin-top .5rem
  .yhy
    width 100%
